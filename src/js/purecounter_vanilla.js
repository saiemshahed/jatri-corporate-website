     ...
     function e() { 
          ...
          if ("IntersectionObserver" in window && 
               ...
               function n(e, t) { 
                    e.forEach((
                         function (e) { 
                              var n = e.target || e, c = r(n); 
                              if (c.duration <= 0) 
                                   return n.innerHTML = o(c.end, c);
                              if (!t && !a(e) || t && e.intersectionRatio < .5) { 
                                   ...
                                   function () { 
                                        return function (e, t) { 
                                             ...
                                             var a = i(t.start); 
                                             e.innerHTML = o(a, t), !0 === t.once && e.setAttribute("data-purecounter-duration", 0); 
                                             var c = setInterval((
                                                  function () { 
                                                       var s = function (e, t) { 
                                                            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "inc"; 
                                                            return e = i(e), t = i(t), parseFloat("inc" === n ? e + t : e - t) 
                                                       }(a, n, r); 
                                                       e.innerHTML = o(s, t), ((a = s) >= t.end && "inc" == r || a <= t.end && "dec" == r) && 
               ...
               function r(e) { 
                    ...
                    return t.forEach((
                         function (e) { 
                              var t = e.name.replace("data-purecounter-", "").toLowerCase(), r = "duration" == t ? parseInt(1e3 * i(e.value)) : i(e.value); 
                              n[t] = r 
                         }
                    )), Object.assign({
                    ...
                    var n = { minimumFractionDigits: t.decimals, maximumFractionDigits: t.decimals }; 
                    return function (e, t) { 
                         return t.separator ? e.replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,").replace(new RegExp(/,/gi, "gi"), t.separatorsymbol) : e.replace(new RegExp(/,/gi, "gi"), "") 
                    }((e = t.currency ? function (e, t) { 
                         var n = t.currencysymbol || "", r = t.decimals || 1; 
                         return n + ((e = Math.abs(Number(e))) >= 1e12 ? "".concat((e / 1e12).toFixed(r), " T") : e >= 1e9 ? "".concat((e / 1e9).toFixed(r), " B") : e >= 1e6 ? "".concat((e / 1e6).toFixed(r), " M") : e >= 1e3 ? "".concat((e / 1e12).toFixed(r), " K") : e.toFixed(r)) }(e, t) : parseFloat(e)).toLocaleString(void 0, n), t) 
                    } function i(e) { 
